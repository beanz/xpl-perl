...
The constructor creates a new xPL::Validation::Integer object.  The
constructor takes a parameter hash as arguments.  Common parameters
are described in L<xPL::Validation>.  This validator type has no
