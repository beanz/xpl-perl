package xPL::Message::sensor::network;

# $Id: network.pm 85 2006-01-14 07:53:24Z beanz $

=head1 NAME

xPL::Message::sensor::network - Perl extension for xPL message base class

=head1 SYNOPSIS

  use xPL::Message::sensor::network;

  my $msg = xPL::Message::sensor::network
