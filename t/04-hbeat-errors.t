...
is(test_error(sub {
   ...
   "xPL::Message::hbeat::app::xplstat->parse_body_parameters: requires 'port' parameter in body",
...
is(test_error(sub {
   ...
   "xPL::Message::hbeat::app::xplstat->parse_body_parameters: requires 'remote_ip' parameter in body",
...
is(test_error(sub {
   ...
   "xPL::Message::hbeat::app::xplstat->port: port, 123, is invalid.
...
is(test_error(sub {
   ...
   "xPL::Message::hbeat::app::xplstat->port: port, 99999, is invalid.
It should be an integer between 1024 and 65535.",
...
is(test_error(sub {
   ...
   "xPL::Message::hbeat::app::xplstat->port: port, notvalid, is invalid.
It should be an integer between 1024 and 65535.",
...
is(test_warn(sub {
   ...
   'xPL::Message::hbeat::app::xplstat->parse_body_parameters: requires '.
